var Cache, FS, HTTP, HTTPRequest, HTTPResponse, HTTPS, Path, QS, Resource, Resources, STATUS, URL, indent, inspect, partial;
...
Resources = (function() {
  ...
  function Resources(window) {
    ...
    makeRequest = __bind(function(method, url, data, headers, resource, callback) {
      var body, boundary, client, cookies, lines, request, response_handler, secure;
      url = URL.parse(url);
      ...
      if (url.protocol === "file:") {
        ...
        if (method === "GET") {
          FS.readFile(Path.normalize(url.pathname), __bind(function(err, data) {
            var response;
            if (err) {
              window.browser.log(function() {
      ...
      client = (secure ? HTTPS : HTTP).request(request, response_handler);
