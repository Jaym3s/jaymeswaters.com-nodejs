...
XMLHttpRequest = function(window) {
      ...
      return window._eventloop.perform(__bind(function(done) {
        return process.nextTick(__bind(function() {
          try {
            ...
            return window.document.trigger("error", "State change: " + error.message, error);
          } finally {
            done();
          }
        }, this));
  ...
  reset = __bind(function() {
    ...
    return this.open = function(method, url, async, user, password) {
      var aborted, headers, _ref, _ref2;
      ...
      if ((_ref = url.protocol) !== "http:" && _ref !== "https:") {
        throw new core.DOMException(core.NOT_SUPPORTED_ERR, "Only HTTP/S protocol supported");
      }
      if (url.auth) {
        _ref2 = url.auth.split(":"), user = _ref2[0], password = _ref2[1];
      }
      this._error = null;
      aborted = false;
      this.abort = function() {
